...
export const GET_COMPANY_DETAIL = "/companies"
export const ADD_NEW_COMPANY = "/add/companies"
export const UPDATE_COMPANY = "/update/companies"
export const DELETE_COMPANY = "/delete/companies"
