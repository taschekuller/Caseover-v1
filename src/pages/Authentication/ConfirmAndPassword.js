...
import { emailConfirm as onPostEmailConfirm ,
  ConfirmPassword as onConfirmPassword
} from "store/actions"
//redux
...
const Confirm = props => {
  ...
  const handleValidProductSubmit = (e, values) => {
    if (values.password != values.passwordConfirm) {
      ...
      dispatch(onConfirmPassword(newBrand))
        ...
        <Container fluid className="p-0">
          <Row className="g-0">
            ...
            (   <Modal isOpen={passwordModal}  >
              ...
              <ModalBody>
                {passwordMatch?(
                  <div className="alert alert-danger h6 text-center">
                  {props.t("Şifreler Eşleşmiyor")} 
